...
class Alumno{
    ...
    public function __construct($pnombre,$papellido, $pedad, $legajo) {
    ...
    public static function TraerTodoLosAlumnos()
	{
			...
			$consulta =$objetoAccesoDato->RetornarConsulta("select id,nombre as nombre, apellido as apellido,edad as edad, legajo as legajo from ALUMNOS");
			$consulta->execute();			
	...
	{
			$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
			$consulta =$objetoAccesoDato->RetornarConsulta("select id,nombre as nombre, apellido as apellido,edad as edad, legajo as legajo from ALUMNOS where id = $id");
			$consulta->execute();
    ...
    public function InsertarElAlumno()
	 {
				$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
				$consulta =$objetoAccesoDato->RetornarConsulta("INSERT into ALUMNOS (nombre,apellido,edad,legajo)values('$this->nombre','$this->apellido','$this->edad','$this->legajo')");
				$consulta->execute();
    ...
    public static function TraerTodoLosCds()
	{
			...
			$consulta->execute();			
			return $consulta->fetchAll(PDO::FETCH_CLASS, "ALUMNOS");		
	}
